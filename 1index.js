...
// =========================
// MINI HTTP (Render Free – ucisza port scan)
// =========================
...
client.on(Events.InteractionCreate, async interaction => {
  ...
  if (
    ...
    return interaction.editReply({ content: `✅ Utworzono ${thread}` });
  }

  // CLOSE PRIVATE
  if (interaction.customId === 'close_private') {
    await interaction.deferReply({ ephemeral: true });
